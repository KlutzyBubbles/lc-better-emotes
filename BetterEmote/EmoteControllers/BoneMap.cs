...
namespace BetterEmote
{
    public static class BoneMap
    {
        ...
        static void MapBone(string bonePath, string sourceBonePath = "")
        {
            ...
            {
                if (playerBone == null)
                    Plugin.Logger.LogError("Failed to find humanoid bone at path: " + bonePath + " and player bone at path: " + sourceBonePath);
                else
                    Plugin.Logger.LogError("Failed to find humanoid bone at path: " + bonePath);
            }
            else if (playerBone == null)
                Plugin.Logger.LogError("Failed to find player bone at path: " + sourceBonePath);
            else
